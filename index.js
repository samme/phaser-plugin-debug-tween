...
(function() {
  "use strict";
  var DebugTween, Phaser,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

  Phaser = this.Phaser;

  Phaser.Plugin.DebugTween = Object.freeze(DebugTween = (function(superClass) {
    var _arr, _rect, colors, tweenColor, tweenDataColor, tweenDataKeys, tweenKeys;
    ...
    DebugTween.prototype.debugTweenDataValues = function(tweenData, x, y) {
      var debug, prop, vEnd, vStart, val;
      debug = this.game.debug;
